...
const T: Record<Lang, Translations> = {
  en: {
    ...
    home: {
      ...
      hero: "Build your website in minutes. No coding, no complexity, a fast professional presence at $5/month billed annually ($10 discount included), with Arabic support so you can grow in Syria.",
      cta: "Get started Now",
      features: [
        ...
        { title: "Affordable Pricing", desc: "Get a proper business website for just $5/month, billed annually with a $10 discount ($50/year)." },
      ...
      whyUs: [
        ...
        { title: "Unbeatable Pricing", desc: "At $5/month billed annually ($10 discount included), SyrFlow is the most affordable business website solution in Syria." },
    ...
    pricing: {
      ...
      monthly: "monthly", billedAnnually: "USD/year - Billed Annually ($10 discount included)",
  ...
  ar: {
    ...
    home: {
      ...
      hero: "أنشئ موقعك في دقائق. بدون برمجة، بدون تعقيد، حضور احترافي سريع بـ 5 دولارات شهرياً تُدفع سنوياً (مع خصم 10 دولارات)، مع دعم عربي لتنمو أعمالك في سوريا.",
      cta: "ابدأ الآن",
      features: [
        ...
        { title: "أسعار في متناول الجميع", desc: "احصل على موقع تجاري احترافي بـ 5 دولارات شهرياً، تُدفع سنوياً مع خصم 10 دولارات (50 دولاراً في السنة)." },
      ...
      whyUs: [
        ...
        { title: "أسعار لا تُضاهى", desc: "بـ 5 دولارات شهرياً تُدفع سنوياً (مع خصم 10 دولارات)، سوريا فلو هو أكثر حلول مواقع الأعمال توفراً في سوريا." },
    ...
    pricing: {
      ...
      monthly: "شهرياً", billedAnnually: "دولار/سنة - تُدفع سنوياً (شامل خصم 10 دولارات)",
