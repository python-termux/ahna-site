...
export function welcomeEmailHtml({ businessName }: { businessName: string }): string {
  ...
  const ar = `
      ...
      <div class="callout callout-amber">
        ...
        <p class="callout-text">موقعك متاح لك فقط أثناء تسجيل دخولك. لتفعيله للعامة، يُرجى دفع رسوم الاشتراك: 5 دولارات شهرياً تُدفع سنوياً مع خصم 10 دولارات (50 دولاراً في السنة).</p>
  ...
  const en = `
      ...
      <div class="callout callout-amber">
        ...
        <p class="callout-text">Your site is only visible to you while you're logged in. To activate it publicly, please pay the subscription: $5/month billed annually with a $10 discount ($50/year).</p>
